  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
      ...
      <button
        ...
        className={cn(buttonVariants(), 'mt-1 h-10 w-full text-sm disabled:opacity-60')}
      >
      ...
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <button
          ...
          className="flex h-9 items-center justify-center gap-2 rounded-lg border border-border bg-card px-3 text-sm font-medium text-foreground transition-colors hover:bg-muted disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <button
          ...
          aria-describedby={`${uid}-apple-desc`}
          className="relative flex h-9 items-center justify-center gap-2 rounded-lg border border-border bg-card px-3 text-sm font-medium text-muted-foreground cursor-not-allowed select-none"
        >
          ...
          Apple
          <span className="ml-1 rounded bg-muted px-1.5 py-0.5 text-[10px] font-medium tracking-wide text-muted-foreground">
            Soon
          </span>
        </button>
        <span id={`${uid}-apple-desc`} className="sr-only">
          Apple sign-in is coming soon and is not yet available.
        </span>
      </div>
